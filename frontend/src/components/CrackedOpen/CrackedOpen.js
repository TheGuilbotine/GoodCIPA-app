    ...
    return (
        <div className='review-list__container'>
            ...
            {reviews && reviews.map(review => (
                <div key={review.id}className='review-list__review__container'>
                    <div className='review-list__left'>
                        <div className='review-list__img__container'>
                            <div className='review-list__review-link__image__container'>
                                <NavLink to={`/ipas/${review.IPA.id}`} key={review.IPA.id} className='review-list__review-link__image'>
